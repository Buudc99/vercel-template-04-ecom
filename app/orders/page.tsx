      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="mx-auto w-full">
          <div className="gap-4 sm:flex sm:items-center sm:justify-between">
            <h2 className="text-4xl font-semibold mb-4 text-gray-900 dark:text-white sm:text-2xl">
              My orders
            </h2>
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            {Array.from({length: 5}).map((_, index) => (
              <div
                key={index + "or"}
                className={`mt-2 flow-root hover:scale-105 transition-all duration-500 hover:z-50 hover:shadow-lg rounded-xl px-6 ${index % 2 === 0 ? "bg-slate-50" : "bg-slate-100"}`}
              >
                <div className="flex flex-wrap items-center gap-y-4 py-6">
                  ...
                  <div className="w-full grid sm:grid-cols-2 lg:flex lg:w-64 lg:items-center lg:justify-end gap-4">
                    <button
                      type="button"
                      className="w-full rounded-lg text-nowrap border transition-all duration-500 border-green-700 px-3 py-2 text-center text-sm font-medium text-green-700 hover:bg-green-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-green-300 dark:border-green-500 dark:text-green-500 dark:hover:bg-green-600 dark:hover:text-white dark:focus:ring-green-900 lg:w-auto"
                    >
                      Re-order
                    </button>
                    <button
                      type="button"
                      className="w-full rounded-lg border transition-all duration-500 border-red-700 px-3 py-2 text-center text-sm font-medium text-red-700 hover:bg-red-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-red-300 dark:border-red-500 dark:text-red-500 dark:hover:bg-red-600 dark:hover:text-white dark:focus:ring-red-900 lg:w-auto"
                    >
                      Cancel
                    </button>
                    <Link
                      href={`/orders/or_123456789`}
                      className="w-full inline-flex justify-center transition-all duration-500 rounded-lg  border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 lg:w-auto"
                    >
                      Details
                    </Link>
                  </div>
